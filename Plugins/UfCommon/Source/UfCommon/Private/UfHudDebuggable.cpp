...
FString IUfHudDebuggable::PrintfImpl(const TCHAR* Fmt, ...)
{
...
// Add default functionality here for any IUfHudDebuggable functions that are not pure virtual.
void IUfHudDebuggable::DrawInfo(UWorld* World, const FVector& Location, const FColor Color, const float Scale, const FString& Text)
{
